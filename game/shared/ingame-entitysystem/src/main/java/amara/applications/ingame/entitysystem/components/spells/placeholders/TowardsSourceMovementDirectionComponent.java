 ...
 */
@Serializable
public class TowardsSourceMovementDirectionComponent {

    public TowardsSourceMovementDirectionComponent(){

    }

    public TowardsSourceMovementDirectionComponent(float angle_Degrees){
