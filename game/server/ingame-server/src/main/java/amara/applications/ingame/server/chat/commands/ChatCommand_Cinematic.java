    ...
    public void execute(String optionString, EntityWorld entityWorld, Game game, GamePlayer gamePlayer) {
        try {
            ...
            switch (cinematicIndex) {
                case 0:
                    entityWorld.setComponent(Map.GAME_ENTITY, new CinematicComponent("amara.applications.ingame.maps.TestMap_TestCinematic"));
                    break;

                case 1:
                    entityWorld.setComponent(Map.GAME_ENTITY, new CinematicComponent("amara.applications.ingame.maps.Map_Destroforest_CinematicIntro"));
                    break;
            }
