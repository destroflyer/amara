...
import amara.engine.applications.masterserver.server.network.messages.Message_CreateLobby;
...
public class PanCreateLobby extends javax.swing.JPanel{
    ...
    public PanCreateLobby(){
        initComponents();
        JComponent btnPlay = FrameUtil.addImageBackgroundButton(panContainer_btnCreateLobby, new DefaultButtonBuilder("default_150x50", "Create Lobby"));
