...
public class BuffVisualisationSystem_Bubble_Blue extends BuffVisualisationSystem {
    ...
    public BuffVisualisationSystem_Bubble_Blue(EntitySceneMap entitySceneMap, AssetManager assetManager) {
        super(entitySceneMap, assetManager, "bubble_blue");
    }

    @Override
    protected Spatial createBuffVisualisation(EntityWorld entityWorld, int targetEntity) {
        return BubbleUtil.createBlue(assetManager);
    }
}
