...
public class BuffVisualisationSystem_Dosaz_Teleport extends BuffVisualisationSystem {
    ...
    public BuffVisualisationSystem_Dosaz_Teleport(EntitySceneMap entitySceneMap, AssetManager assetManager) {
        super(entitySceneMap, assetManager, "dosaz_teleport");
    }

    @Override
    protected Spatial createBuffVisualisation(EntityWorld entityWorld, int targetEntity) {
        Node node = new Node();
        Geometry geometry = GroundTextures.create(assetManager, "Textures/effects/dosaz_teleport_marker.png", -2.5f, 2.5f, 5, 5, RenderState.BlendMode.AlphaAdditive);
