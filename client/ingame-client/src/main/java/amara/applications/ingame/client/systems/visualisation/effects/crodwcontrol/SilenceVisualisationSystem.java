...
public class SilenceVisualisationSystem extends TopHUDAttachmentSystem {
    ...
    public SilenceVisualisationSystem(HUDAttachmentsSystem hudAttachmentsSystem, EntityHeightMap entityHeightMap, AssetManager assetManager) {
        super(hudAttachmentsSystem, entityHeightMap, IsSilencedComponent.class, assetManager);
    ...
    protected Spatial createVisualAttachment(EntityWorld entityWorld, int entity) {
        ...
        Material material = MaterialFactory.generateUnshadedMaterial(assetManager, "Textures/effects/silence.png");
