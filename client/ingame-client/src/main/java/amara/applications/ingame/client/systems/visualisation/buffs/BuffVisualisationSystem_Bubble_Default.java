...
public class BuffVisualisationSystem_Bubble_Default extends BuffVisualisationSystem {
    ...
    public BuffVisualisationSystem_Bubble_Default(EntitySceneMap entitySceneMap, AssetManager assetManager) {
        super(entitySceneMap, assetManager, "bubble");
    }

    @Override
    protected Spatial createBuffVisualisation(EntityWorld entityWorld, int targetEntity){
        return BubbleUtil.createDefault(assetManager);
    }
}
