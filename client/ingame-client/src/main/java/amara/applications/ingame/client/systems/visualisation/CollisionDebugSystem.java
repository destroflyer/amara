...
public class CollisionDebugSystem implements EntitySystem {
    ...
    public CollisionDebugSystem(Node node, AssetManager assetManager) {
        this.node = node;
    ...
    private void updateGeometry(EntityWorld entityWorld, int entity) {
        ...
        if (hitboxComponent != null) {
            Geometry collisionMeshGeometry = MapObstaclesAppState.generateGeometry(assetManager, hitboxComponent.getShape(), entityWorld.hasComponent(entity, HitboxActiveComponent.class));
