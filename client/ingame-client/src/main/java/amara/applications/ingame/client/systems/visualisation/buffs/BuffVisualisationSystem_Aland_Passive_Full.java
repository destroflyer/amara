...
public class BuffVisualisationSystem_Aland_Passive_Full extends BuffVisualisationSystem {
    ...
    public BuffVisualisationSystem_Aland_Passive_Full(EntitySceneMap entitySceneMap, AssetManager assetManager) {
        super(entitySceneMap, assetManager, "aland_passive_full");
    }

    @Override
    protected Spatial createBuffVisualisation(EntityWorld entityWorld, int targetEntity) {
        Node node = new Node();
        Geometry geometry = GroundTextures.create(assetManager, "Textures/effects/aland_passive_full.png", -1.5f, 1.5f, 3, 3);
