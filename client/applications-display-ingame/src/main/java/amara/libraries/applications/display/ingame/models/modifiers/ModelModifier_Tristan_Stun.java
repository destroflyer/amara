...
public class ModelModifier_Tristan_Stun extends ModelModifier {
    ...
    public void modify(RegisteredModel registeredModel, AssetManager assetManager) {
        registeredModel.getNode().attachChild(GroundTextures.create(assetManager, "Models/tristan_stun/resources/diffuse.png", -1.5f, 9, 3, 9, RenderState.BlendMode.AlphaAdditive));
    }
}
