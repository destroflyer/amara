...
public class MapTerrain {
    ...
    public MapTerrain(Map map, AssetManager assetManager) {
        this.map = map;
        loadHeightmap(assetManager);
    ...
    private void loadHeightmap(AssetManager assetManager) {
    ...
    private void loadMaterial(AssetManager assetManager) {
