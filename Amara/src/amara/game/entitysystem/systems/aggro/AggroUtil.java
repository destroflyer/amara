...
public class AggroUtil{
    ...
    public static void tryDrawAggro(EntityWorld entityWorld, Integer entity, Integer targetEntity){
        if(!entityWorld.hasComponent(entity, AggroTargetComponent.class)){
            drawAggro(entityWorld, entity, targetEntity);
        }
    }
    
    public static void drawAggro(EntityWorld entityWorld, Integer entity, Integer targetEntity){
