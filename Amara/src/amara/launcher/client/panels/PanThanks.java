...
public class PanThanks extends javax.swing.JPanel{
    ...
    private static final Thanks[] THANKS = new Thanks[]{
        ...
        new Thanks("Icecold", "Co-worker, Tester", "/Interface/client/user.png"),
        new Thanks("Yalee", "Tester", "/Interface/client/user.png"),
        new Thanks("XBody", "Models, Tester", "/Interface/client/user.png"),
        new Thanks("seeba", "Tester", "/Interface/client/user.png"),
        new Thanks("Marcel", "Code structure advices", "/Interface/client/thanks/enton.png"),
        new Thanks("FixIcon", "Icon set \"Marcet Icons\"", "/Interface/client/resources/0.png"),
        new Thanks("Icojoy", "Icon set \"New Year Icojoy\"", "/Interface/client/resources/1.png"),
        new Thanks("antialiasfactory", "Icon set \"Jewelry Professional Icons\"", "/Interface/client/resources/2.png", "http://antialiasfactory.deviantart.com"),
        new Thanks("Cavemanmac", "Icon set \"Witchery Icons\"", "/Interface/client/resources/3.png"),
        new Thanks("hush66", "Icon set \"Magic The Gathering Mana\"", "/Interface/client/mana/0.png", "http://hush66.deviantart.com"),
        ...
        new Thanks("silveralv", "Model \"House\", \"Turm\"", "/Interface/client/thanks/blender.png", "http://silveralv.deviantart.com"),
        new Thanks("yazjack", "Model \"Stock\", \"Kaserne\"", "/Interface/client/thanks/blender.png", "http://yazjack.deviantart.com"),
        ...
        new Thanks("xuroiux", "Model \"Tree\"", "/Interface/client/thanks/blender.png", "http://www.blendswap.com/blends/author/xuroiux"),
