...
public class CustomGameTemplates {
    ...
    public static void registerLoader() {
        ...
        EntityTemplate.setImplementation(() -> new EntityTemplateReader() {

            private XMLTemplateReader xmlTemplateReader = new XMLTemplateReader(xmlTemplateManager, this);

            @Override
            protected void loadTemplate(EntityWorld entityWorld, int entity, EntityTemplate template) {
                EntityWrapper entityWrapper = entityWorld.getWrapped(entity);
                xmlTemplateManager.loadTemplate(xmlTemplateReader, entityWorld, entity, template);
                if (template.getName().equals("spells/event_horizon_object")) {
                    ...
                    EntityWrapper autoAttack = createFromTemplate(entityWorld, "spells/melee_autoattack");
                    ...
                    EntityWrapper autoAttack = createFromTemplate(entityWorld, "spells/ranged_autoattack(model=Models/3dsa_archer_arrow/skin.xml)");
                    entityWrapper.setComponent(new AutoAttackComponent(autoAttack.getId()));
                    entityWrapper.setComponent(new AutoAggroComponent(12));
                    entityWrapper.setComponent(new MaximumAggroRangeComponent(30));
                    entityWrapper.setComponent(new AggroResetTimerComponent(3));
                    ...
                    EntityWrapper autoAttack = createFromTemplate(entityWorld, "spells/ranged_autoattack(model=Models/3dsa_fire_dragon_fireball/skin.xml)");
                    entityWrapper.setComponent(new AutoAttackComponent(autoAttack.getId()));
                    ...
                    loadTemplate(entityWorld, entity, "units/pseudospider");
                    ...
                    int radius = template.getIntegerInput("radius");
                    int circlePointsCount = 32;
                    Vector2f[] circlePoints = PointUtil.getCirclePoints(radius, circlePointsCount);
